...
Google Merchant Center powers Google Shopping listings and product feed visibility for ecommerce sales.
...
For quote-only or highly customized items, use Shopify products carefully. Products that require custom pricing should either use quote CTAs or clearly defined purchasable starting packages.
